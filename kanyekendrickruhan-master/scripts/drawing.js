...
if (window.addEventListener) {
    window.addEventListener('load', function() {
        ...
        function init() {
            ...
            // Get the tool select and color select input.
            ...
            // Activate the default tool and color.
        ...
        function ev_canvas(ev) {
            ...
            var func = color[ev.type];
            if (func) {
                func(ev);
            }
        }

        // The event handler for any changes made to the tool selector and color selector.
        ...
        // This object holds the implementation of each drawing tool / color.
        var tools = {};
        var colors = {};
